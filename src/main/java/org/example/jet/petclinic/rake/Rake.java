package org.example.jet.petclinic.rake;
 ...
 *
 * Code taken from https://github.com/Linguistic/rake
 */
public class Rake {
    String language;
    ...
    public Rake(String language) {
        ...
        InputStream stream = this.getClass().getResourceAsStream("/data/" + language + ".txt");
        String line;
